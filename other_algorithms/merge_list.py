...
access_sequence.extend(access_sequence1)
access_sequence.extend(access_sequence2)
access_sequence.extend(access_sequence3)
access_sequence.extend(access_sequence4)
rw_sequence.extend(rw_sequence1)
rw_sequence.extend(rw_sequence2)
rw_sequence.extend(rw_sequence3)
rw_sequence.extend(rw_sequence4)
...
f = open(file_path + "//1core_rwnum.txt",'a')
...
f = open(file_path + "//1core_num.txt",'a')
