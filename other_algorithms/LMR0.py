...
if __name__ == "__main__":
    ...
    for i in range(num_data_SRAM):
        ...
        count_s1[count_s1.index(max(count_s1))] = 0
    ...
    print(data_SRAM)
    print("LMR0的cost减少的百分比", cost_reduce, "LMR0的shift减少的百分比", shift_reduce, "LMR0的延迟", cost1, "LMR0的shift", Ns1)
    print("LMR0的能耗为：", energy)