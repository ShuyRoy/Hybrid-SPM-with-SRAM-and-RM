...
print("11111111111111111111",len(access_sequence))
...
print("2222222222222",len(access_sequence1))

f = open(file_path + "//bitcount_reverse.txt",'a')
...
f.close()
print("Success!")
f = open(file_path + "//basicmath_reverse.txt",'a')
